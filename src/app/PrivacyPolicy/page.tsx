export default function Page() {
  return (
    <div className="lg:p-16 p-5 xl:p-28 border-b-2">
      ...
      managing authority. Company (referred to as either the Company , We , Us
      or Our in this Agreement) refers to Casa Vibha. Cookies are small files
      ...
      among its many uses. Country refers to: Tamil Nadu, India Device means any
      device that can access the Service such as a computer, a cellphone or a
      digital tablet. Personal Data is any information that relates to an
      ...
      itself (for example, the duration of a page visit). Website refers to Casa
      Vibha, accessible from www.casavibha.com You means the individual
      ...
      limited to: Email address First name and last name Phone number Address,
      State, Province, ZIP/Postal code, City Usage Data Usage Data Usage Data is
      ...
      <br />
      Information from Third-Party Social Media Services The Company allows You
      to create an account and log in to use the Service through the following
      Third-party Social Media Services: Google Facebook Instagram Twitter
      LinkedIn If You decide to register through or otherwise grant us access to
      a Third-Party Social Media Service, We may collect Personal data that is
      ...
      list associated with that account. You may also have the option of sharing
      ...
      this Privacy Policy. Tracking Technologies and Cookies We use Cookies and
      ...
      so that it will refuse Cookies, our Service may use Cookies. Web Beacons.
      ...
      a certain section and verifying system and server integrity). Cookies can
      ...
      Cookies are deleted as soon as You close Your web browser. Learn more
      about cookies on the Privacy Policies website article. <br />
      ...
      those services. Cookies Policy / Notice Acceptance Cookies Type:
      ...
      including to monitor the usage of our Service. To manage Your Account: to
      ...
      contract for the products, items or services You have purchased or of any
      other contract with Us through the Service. To contact You: To contact You
      ...
      necessary or reasonable for their implementation. To provide You with
      ...
      to Us. For business transfers: We may use Your information to evaluate or
      ...
      Service, products, services, marketing and your experience. We may share
      Your personal information in the following situations: With Service
      ...
      another company. With Affiliates: We may share Your information with Our
      ...
      that are under common control with Us. With business partners: We may
      ...
      to review this Privacy Policy periodically for any changes. <br />
      Changes to this Privacy Policy are effective when they are posted on this
      page. <br />
      Contact Us If you have any questions about this Privacy Policy, You can
      contact us: By email: help@casavibha.com
    </div>
  )
}
