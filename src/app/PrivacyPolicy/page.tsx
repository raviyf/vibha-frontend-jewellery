export default function Page() {
  return (
    <div className="lg:p-16 p-5 xl:p-28 border-b-2">
      ...
      on the collection, use and disclosure of Your information when You use the
      ...
      "Us" or "Our" in this Agreement) refers to Casa Vibha. Cookies are small
      ...
      website among its many uses. Country refers to: Tamil Nadu, India Device
      ...
      Website. Service Provider means any natural or legal person who processes
      ...
      Collected Personal Data While using Our Service, We may ask You to provide
      Us with certain personally identifiable information that can be used to
      contact or identify You. Personally identifiable information may include,
      but is not limited to: Email address First name and last name Phone number
      ...
      about cookies on the Privacy Policies website article. We use both Session
      and Persistent Cookies for the purposes set out below: Necessary /
      Essential Cookies Type: Session Cookies Administered by: Us Purpose: These
      ...
      these Cookies, the services that You have asked for cannot be provided,
      and We only use these Cookies to provide You with those services. Cookies
      ...
      You make when You use the Website, such as remembering your login details
      or language preference. The purpose of these Cookies is to provide You
      ...
      usage of our Service. To manage Your Account: to manage Your registration
      as a user of the Service. The Personal Data You provide can give You
      access to different functionalities of the Service that are available to
      You as a registered user. For the performance of a contract: the
