  ...
  return (
    <h1 className="lg:p-16 p-5 xl:p-28 border-b-2">
      ...
      <p>
        ...
        ("Terms") govern your access to and use of our website and its related
        ...
        Service. Eligibility You must be at least 18 years old to use our
        Service or of legal age to form a binding contract with casavibha.com in
        your jurisdiction. If you are using the Service on behalf of a company,
        organization, or other entity, you represent that you have the authority
        to bind such entity to these Terms. Account Registration To access
        certain features of the Service, you may be required to create an
        account. You agree to provide accurate, current, and complete
        information during the registration process and to update such
        information to keep it accurate, current, and complete. casavibha.com
        ...
        information. You represent and warrant that: (i) you have the legal
        right to use any credit card(s) or other payment method(s) in connection
        with any Purchase; and that (ii) the information you supply to us is
        true, correct, and complete. Termination We may terminate or suspend
        your account and bar access to the Service immediately, without prior
        ...
        of the Terms. Limitation of Liability In no event shall casavibha.com,
        ...
        purpose. Governing Law These Terms shall be governed and construed in
        accordance with the laws of India ,without regard to its conflict of law
        provisions. Changes We reserve the right, at our sole discretion, to
        modify or replace these Terms at any time. We will provide notice of any
        changes by posting the new Terms on the Service. By continuing to access
        or use our Service after those revisions become effective, you agree to
        be bound by the revised terms. Contact Us If you have any questions
        about these Terms, please contact us at:  Email: help@casavibha.com 
        Address: 65-C, 1st St, Block V, Block T, Anna Nagar, Chennai, Tamil Nadu
        600040.
      </p>
    </h1>
  )
