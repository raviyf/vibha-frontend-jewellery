  ...
  return (
    <h1 className="lg:p-16 p-5 xl:p-28 border-b-2">
      ...
      <p>
        ...
        description of services/products offered]. These Terms of Service Terms
        govern your access to and use of our website and its related services
        ...
        then you do not have permission to access the Service. Eligibility You
        must be at least 18 years old to use our Service or of legal age to form
        a binding contract with casavibha.com in your jurisdiction. If you are
        using the Service on behalf of a company, organization, or other entity,
        you represent that you have the authority to bind such entity to these
        Terms. Account Registration To access certain features of the Service,
        you may be required to create an account. You agree to provide accurate,
        ...
        Governing Law These Terms shall be governed and construed in accordance
