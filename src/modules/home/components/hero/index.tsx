...
const Hero = () => {
  return (
    <div className=" row-span-3 flex flex-row  md:pt-16 relative h-full">
      <img
        src="/imgjewel.jpg"
        alt="f1"
      ...
      /> */}
      <div className="absolute flex flex-col text-lg pt-[6rem] pl-[3rem] sm:pt-[10rem] sm:pl-[8rem] md:pt-[16rem] md:pl-[14rem] lg:pl-[18rem]">
